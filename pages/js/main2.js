...
color.onclick = () => {
    ...
    var background2 = color.style.background;
    var background3 = color.style.background;

    document.querySelector('.visitInfo').style.setProperty('background-color', background1);
    document.querySelector('.visitInfo1').style.setProperty('background-color', background2);
    document.querySelector('.dashBorder1').style.setProperty('border-color', background3);
    document.querySelector('.itemContain,.itemContainQRScan,.tableApproveScan,.bodyContent,.dashBorder,.bodyContentVisitList').style.setProperty('border-color', background3);  }
});
