...
//end sidebar infos
    ...
    //GET LOGS
    $getLogs = mysqli_query($connection, "SELECT * FROM all_logs WHERE account_id = '$accountID' ORDER BY log_id DESC");
...
<body>
    <div class="position-relative">
        ...
        <div class="content bg-light" >
                ...
                <!-- Add Guard Start -->
                <nav class="navbar navbar-light bg-light justify-content-center mb-2 head1">
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="mb-3 row justify-content-center">
                                    <div class="col-auto">
                                        <img src="guardQR/<?php echo $qrName[0];?>" alt="">
                                    </div>
                                </div>                           
                            </div>
