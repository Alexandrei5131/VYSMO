<?php
    ...
    $sqlGetVisitOpenEvent = mysqli_query($connection, "SELECT * FROM visit_openevent");
                ...
                <?php
                        if($_SESSION['role'] == 'Admin'){
                            echo '
                                ...
                                <a href="openEventHistory.php" class="nav-item nav-link active"><i class="bi bi-clock-history"></i> Open Event History</a>
                            ';
                        }     
                    ?>
            ...
            <div class="container-fluid bodyContent mt-3 col">
                <div class="bg-light text-center rounded">
                    <nav class="navbar navbar-light justify-content-center visitInfo">
                        <span class="navbar-brand mb-0 h1 text-white">Open Event History</span>
                    </nav>
                    <div class="p-4">
                        <div class="row mb-3 lgScreenEvent"> <!--For Desktop-->      <!--From Date-->
                                    ...
                                    <div class="lgScreenEvent">     
                                        <div class="container-fluid">
                                            <div class="row">
                                                ...
                                                <div class="col-auto">
                                                    <input type="date" class="form-control" class="fromDate" id="fromDate" max="<?php echo $dateToday;?>" >
                                                </div>
                                                <div class="col-auto">
                                                    <label for="toDate" class="col-form-label labelBlend">To:</label>
                                                </div>
                                                <div class="col-auto">
                                                    <input type="date" class="form-control" class="toDate" id="toDate" disabled >
                                                </div>
                                            </div>
                                        </div>
                                    </div> 
                                ...
                                <div class="col-auto">
                                    <a type="button" class="btn btn-primary" id="openEventHistoryReport"> 
                                            Download Report
                                    </a>
                                </div>
                                ...
                                <script>
                                    document.getElementById('openEventHistoryReport').addEventListener('click', function() {
                                        ...
                                        if (fromDate === "" || toDate === "") {
                                            ...
                                            const newWindow = window.open(`printdocs/printOpenEventHistory.php?fromDate=${fromDate}&toDate=${toDate}`, windowName);
                                        }
                                    });
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="table-responsive" id="tableOpenVisitHistory" >
